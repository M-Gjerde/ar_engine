...
void GraphicsPipeline::createRenderPass(Utils::MainDevice mainDevice, VkFormat swapChainImageFormat) {
        ...
        colorAttachment.format = Utils::chooseSupportedFormat(mainDevice, {VK_FORMAT_R8G8B8A8_UNORM}, VK_IMAGE_TILING_OPTIMAL,
...
void GraphicsPipeline::getRenderPass(Utils::MainDevice mainDevice, VkRenderPass *pRenderPass,
                                     VkFormat swapChainImageFormat) {
    createRenderPass(mainDevice, swapChainImageFormat);
...
void GraphicsPipeline::getGraphicsPipeline(Utils::MainDevice mainDevice, VkExtent2D swapChainExtent,
                                           VkPipelineLayout *pPipelineLayout, VkPipeline *pPipeline,
                                           VkPipelineLayout *pPipelineLayout2, VkPipeline *pPipeline2) {

    createGraphicsPipeline(mainDevice, swapChainExtent);

    *pPipelineLayout = pipelineLayout;
    *pPipeline = graphicsPipeline;
    *pPipelineLayout2 = secondPipelineLayout;
    *pPipeline2 = secondPipeline;
